...
$stmt = $dbh->prepare("SELECT e.event_id, e.parent_id, e.title, e.start, e.end, e.resourceID, e.repeat_freq, e.description, e.category_id, r.name, r.resourceID FROM events e LEFT JOIN resources r ON e.resourceID = r.resourceID WHERE e.title=:childName");
